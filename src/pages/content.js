...
export const stages = [
	{
		from: "fév 2023",
		to: "Mars 2023",
		role: "Prédiction de la résiliation de contrat des clients",
		org: "Ooredoo Algérie",
...

	{
		...
		location: "Bejaia, Algeie",
		skills: " L'étude des normes, standards et procédures du service HSE, Étude du SI existant au sein du département, Conception et l'implémentation d'une solution base de données pour la gestion et la maintenance du service HSE, Implémentation d'une interface graphique avec Python"
	}
]
...
export const projects = [
	{
		...
		tech: "Front-end : JavaScript, HTML, CSS, Bootstrap; Back-end : PHP, MYSQL",
	},
	{
		title: "Site Vitrine Commerce Local",
		description: "Site web statique pour le profit d'un commerce local",
		url: "https://bfsup.netlify.app/",
		tech: "HTML, CSS, JS",
	},
	{
...
export const formation = [
	...
	},
	{
		from: "2022",
		to: "2023",
		institute: "Université de Abderahmane Mira",
		course: "Master informatioque : Systèmes d'Informations Avancées",
		location: "Bejaia, Algerie"
	},
	{
		from: "2019",
		to: "2022",
		institute: "Université de Abderahmane Mira",
		course: "Licence informatioque option Système d'Informations",
		location: "Bejaia, Algerie"
	}
]
...
export const contact = [
	...
	},
	{
		...
		source: "https://www.linkedin.com/in/arezki-bazizi-recherche-stage-informatique-d%C3%A9veloppement-web-alternance-/",
	},
]
...
export const certificates = [
	{
		...
		org: "Cisco",
		url: "https://www.credly.com/badges/bcabcfcc-9038-42f7-8f86-d3ad1475b220/linked_in_profile",
...

	{
		...
		org: "Huawei",
		url: "01010080249808459091347973",
	...
	
	{
		...
		org: "Duke University",
		url: "https://www.coursera.org/account/accomplishments/verify/XUYTQZSSEWFB",
		description: "Coursera Certification",
	},

	{
		...
		org: "Duke University",
		url: "https://www.coursera.org/account/accomplishments/verify/NBAK4XGPK69F",
		description: "Coursera Certification",
	},
	{
		issued: "2022",
		...
		org: "Google",
		url: "https://www.coursera.org/account/accomplishments/verify/PBSNSPBE6WXG",
		description: "Coursera Certification",
